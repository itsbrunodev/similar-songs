...
export async function generateMetadata({
  ...
  const title = async () => {
    ...
    if (track.error) return "Similar Songs";

    return `Songs similar to ${track.name} by ${track.artists[0].name}`;
  };
  ...
  return {
    ...
    openGraph: {
      images: [`https://similar-songs.itsbruno.dev/track/${id}/image`],
    },
  };
}
            ...
            <tbody>
              {similarTrackList.tracks.map((track, i) => (
                ...
                >
                  ...
                  {/* actions */}
                  {/* <td className="flex gap-2 text-zinc-400">
                </td> */}
                </tr>
              ))}
            </tbody>
